          ...
          <div className="space-y-10 text-[14px] leading-[1.8] text-[#4a4a4a]">
            ...
            <div>
              ...
              <p className="mt-6 font-bold text-black uppercase tracking-wider">
                For care advice or material questions: <a href="mailto:vrisbyvriti5@gmail.com" className="underline hover:text-black transition-colors lowercase">vrisbyvriti5@gmail.com</a>
              </p>
            </div>
