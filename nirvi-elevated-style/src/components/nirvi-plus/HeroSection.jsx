...
const HeroSection = () => {
  return (
    <section className="relative w-full overflow-hidden bg-background py-16 flex items-center justify-center border-b border-border">
      <div className="absolute inset-0 bg-[url('https://nirvi-images-2026.s3.ap-south-1.amazonaws.com/products/product-1777408935994-8473cae28cd3-ChatGPT+Image+Apr+29%2C+2026%2C+02_01_48+AM.webp')] bg-cover bg-center opacity-5" />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-12">
        ...
        >
          Nirvi<span className="text-[#e0b090] font-display">Plus</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
