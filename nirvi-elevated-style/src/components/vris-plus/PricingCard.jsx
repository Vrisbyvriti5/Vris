  ...
  const handleSubscribe = async () => {
    if (!isAuthenticated) {
      toast({
        ...
        description: 'Please login to subscribe to VRISPlus.',
      });
      navigate('/login?redirect=/vris-plus');
      return;
    }
    ...
    try {
      ...
      const options = {
        ...
        currency: 'INR',
        name: 'VRIS',
        description: 'VRISPlus Membership',
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-center items-stretch gap-8 md:gap-10">
        ...
        >
          <div className="text-center flex-grow">
            <h3 className="text-xl font-display font-bold text-foreground mb-2">VRIS Free</h3>
        ...
        >
          ...
          <div className="text-center flex-grow relative z-10">
            <h3 className="text-2xl font-display font-bold text-foreground mb-2">VRISPlus Membership</h3>
